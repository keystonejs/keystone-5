...
- [`208722a42`](https://github.com/keystonejs/keystone-5/commit/208722a4234434e116846756bab18f7e11674ec8) [#4784](https://github.com/keystonejs/keystone-5/pull/4784) Thanks [@timleslie](https://github.com/timleslie)! - Reordered type definitions for consistency with docs. Remove unused type `ListAdminUIConfig.path`.
...
- [`954350389`](https://github.com/keystonejs/keystone-5/commit/9543503894c3e78a9b69a75cbfb3ca6b85ae34e8) [#4778](https://github.com/keystonejs/keystone-5/pull/4778) Thanks [@timleslie](https://github.com/timleslie)! - Removed the unused `plural`, `singular`, `label`, `db`, and `graphql.cacheHint` list config options.

## 12.0.1

### Patch Changes

- [`6ecd2a766`](https://github.com/keystonejs/keystone-5/commit/6ecd2a766c868d46f84291bc1611eadef79e6100) [#4772](https://github.com/keystonejs/keystone-5/pull/4772) Thanks [@timleslie](https://github.com/timleslie)! - Removed `config.db.dropDatabase` for `prisma_postgresql` and `config.db.knexOptions` for `knex` as they were unused.

* [`777981069`](https://github.com/keystonejs/keystone-5/commit/7779810691c4154e1344ced4fb94c5bb9524a71f) [#4765](https://github.com/keystonejs/keystone-5/pull/4765) Thanks [@timleslie](https://github.com/timleslie)! - Reorganised package internals to allow for easier documentation.

- [`4d808eaa5`](https://github.com/keystonejs/keystone-5/commit/4d808eaa5aa1593ad1e54000d80f674f7c4d12bd) [#4766](https://github.com/keystonejs/keystone-5/pull/4766) Thanks [@timleslie](https://github.com/timleslie)! - Removed `config.db.provider` option, which did not have any meaningful, viable value.

## 12.0.0

### Major Changes

- [`1744c5f05`](https://github.com/keystonejs/keystone-5/commit/1744c5f05c9a13e680aaa1ed151f23f1d015ed9c) [#4763](https://github.com/keystonejs/keystone-5/pull/4763) Thanks [@timleslie](https://github.com/timleslie)! - Removed the type `SchemaConfig`. Updated the `keystone` parameter of `ExtendGraphqlSchema` to be `BaseKeystone`.
...
- [`a96c24cca`](https://github.com/keystonejs/keystone-5/commit/a96c24ccab8dadc9e8f0131fe6509abd64a776f5) [#4696](https://github.com/keystonejs/keystone-5/pull/4696) Thanks [@timleslie](https://github.com/timleslie)! - Marked `db.enableLogging` as optional.
...
- [`57092b7c1`](https://github.com/keystonejs/keystone-5/commit/57092b7c13845fffd1f3767bb609d203afbc2776) [#4465](https://github.com/keystonejs/keystone-5/pull/4465) Thanks [@timleslie](https://github.com/timleslie)! - Updated `SessionStrategy.start` and `SessionStrategy.end` to be required attributes.
...
* [`4b019b8cf`](https://github.com/keystonejs/keystone-5/commit/4b019b8cfcb7bea6f800609da5d07e8c8abfc80a) [#4478](https://github.com/keystonejs/keystone-5/pull/4478) Thanks [@timleslie](https://github.com/timleslie)! - Refactored types to isolate base keystone type definitions.
...
- [`b2de22941`](https://github.com/keystonejs/keystone-5/commit/b2de229419cc93b69ee4027c387cab9c8d701488) [#4288](https://github.com/keystonejs/keystone-5/pull/4288) Thanks [@JedWatson](https://github.com/JedWatson)! - Fixed type for defaultFieldMode in listConfig.ui.itemView
...
- [`166acb9bf`](https://github.com/keystonejs/keystone-5/commit/166acb9bf211e0ee8a90d4740f6ebc54ffe72dec) [#4138](https://github.com/keystonejs/keystone-5/pull/4138) Thanks [@mitchellhamilton](https://github.com/mitchellhamilton)! - Allow field view React components to return null
